...
public:
    int removeDuplicates(int A[], int n) {
    	// distance() determin the number of increments 
    	// between positionsaddressed by two iterators
    	// unique() return an iterator to the element 
    	// follows the last element note removed
